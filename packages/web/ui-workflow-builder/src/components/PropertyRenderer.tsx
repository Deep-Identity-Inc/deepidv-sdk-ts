...
export function PropertyRenderer({
  ...
  if (property.requirement) {
    const reqId =
      typeof property.requirement === 'string' ? property.requirement : property.requirement.id;
          ...
          <label className="deepidv--toggle-row">
            ...
            <span className="deepidv--switch">
              <input
                ...
                onChange={(e) => {
                  onChange(property.id, e.target.checked);
                }}
              />
              <span className="deepidv--switch-track" />
            </span>
          </label>
          {property.sublabel && <p className="deepidv--toggle-sublabel">{property.sublabel}</p>}
        </div>
      );
      ...
      return (
        <div className="deepidv--slider-wrapper">
          <div className="deepidv--slider-header">
            {property.label && <span className="deepidv--slider-label">{property.label}</span>}
            {property.unit === '%' && (
          ...
          <input
            ...
            onChange={(e) => {
              onChange(property.id, Number(e.target.value));
            }}
            min={property.min ?? 0}
          ...
          {property.marks && (
            <div
              style={{
                ...
                fontSize: '0.75rem',
                color: 'var(--deepidv-color-text-secondary)',
              }}
            >
              {property.marks
                .filter(
                  (m) =>
                    m.value === (property.min ?? 0) ||
                    m.value === (property.max ?? 100) ||
                    m.value === Number(property.value),
                )
                .map((m) => (
        ...
        <div className="deepidv--slider-wrapper">
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <input
              ...
              value={rangeValue[0]}
              onChange={(e) => {
                onChange(property.id, [Number(e.target.value), rangeValue[1]]);
              }}
              min={property.min ?? 0}
              max={rangeValue[1]}
            />
            ...
            <input
              ...
              value={rangeValue[1]}
              onChange={(e) => {
                onChange(property.id, [rangeValue[0], Number(e.target.value)]);
              }}
              min={rangeValue[0]}
              max={property.max ?? 100}
            />
          ...
          <div className="deepidv--range-zones">
            ...
            <div className="deepidv--range-zone" style={{ backgroundColor: `${midColor}15` }}>
              ...
              <span className="deepidv--range-zone-value">
      ...
      return (
        <div>
          ...
          <button
            ...
            onClick={() => {
              onChange(property.id, [...items, { text: '' }]);
            }}
          >
      ...
      return (
        <div>
          ...
          <button
            ...
            className="deepidv--add-btn"
            onClick={() => {
              onChange(property.id, [...docs, { text: '' }]);
            }}
          >
