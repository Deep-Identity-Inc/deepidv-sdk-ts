...
export const DEFAULT_STEPS: StepDefinition[] = [
  {
    ...
    propertyGroups: [
      ...
      },
      {
        ...
        properties: [
          { id: 'require-secondary-id', label: 'Require Secondary ID', type: 'boolean', value: false },
          { id: 'require-tertiary-id', label: 'Require Tertiary ID', type: 'boolean', value: false, requirement: 'require-secondary-id' },
        ],
      },
      {
      ...
      },
      {
        ...
        properties: [
          { id: 'minimum-age', label: 'Minimum Age', type: 'range', value: [18, 100], min: 0, max: 100, lowerLabel: 'Too young', upperLabel: 'Too old' },
        ],
      },
      {
  ...
  },
  {
    ...
    propertyGroups: [
      ...
      },
      {
        ...
        properties: [
          { id: 'confidence-threshold', label: 'Confidence Threshold', type: 'slider', value: 70, min: 0, max: 100, step: 1 },
        ],
      },
    ],
  },
    ...
    propertyGroups: [
      {
        ...
        properties: [
          ...
          { id: 'use-custom-word', label: 'Use Custom Challenge Word', type: 'boolean', value: false },
          { id: 'challenge-word', label: 'Challenge Word', type: 'text', value: '', requirement: 'use-custom-word' },
        ],
      },
      {
    ...
    propertyGroups: [
      {
        ...
        properties: [
          { id: 'verification-prompt', label: 'Verification Prompt', type: 'text', required: true, maxLength: 60, value: '' },
        ],
      },
    ],
  },
    ...
    propertyGroups: [
      {
        ...
        properties: [
          { id: 'form-fields', label: 'Fields', type: 'form-fields', value: [] },
        ],
      },
    ],
  },
...
export const DEFAULT_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    steps: ['id-verification', 'face-liveness', 'bank-statement-upload', 'pep-sanctions', 'document-upload'],
  },
  {
    id: 'age-gated',
