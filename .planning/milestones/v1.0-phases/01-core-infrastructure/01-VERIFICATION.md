...
| `packages/core/src/config.ts`                | `DeepIDVConfig` interface and defaults   | ✓ VERIFIED | Exports `DeepIDVConfig`, `ResolvedConfig`, `resolveConfig`, all four DEFAULT\_\* constants                                                                                                                                  |
